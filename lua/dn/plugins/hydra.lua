return {
	...
	config = function()
		...
		Hydra {
			...
			heads = {
				{ "r",     "<C-a>r", { silent = true, desc = "rotate (clockwise)" } },
				{ "R",     "<C-a>R", { silent = true, desc = "Rotate (counter clockwise)" } },
				{ "x",     "<C-a>x", { silent = true, desc = "eXchange" } },
				{ "H",     "<C-a>H", { silent = true, desc = "move left" } },
				{ "J",     "<C-a>J", { silent = true, desc = "move down" } },
				{ "K",     "<C-a>K", { silent = true, desc = "move up" } },
				{ "L",     "<C-a>L", { silent = true, desc = "move right" } },
				{ "<",     "<C-a><", { silent = true, desc = "shrink horizontally" } },
				{ "-",     "<C-a>-", { silent = true, desc = "shrink vertically" } },
				{ "+",     "<C-a>+", { silent = true, desc = "grow vertically" } },
				{ ">",     "<C-a>>", { silent = true, desc = "grow horizontally" } },
				{ "=",     "<C-a>=", { silent = true, desc = "equalize sizes", exit = true } },
				{ "<C-h>", "<C-a>h", { silent = true, desc = "focus left" } },
				{ "<C-j>", "<C-a>j", { silent = true, desc = "focus down" } },
				{ "<C-k>", "<C-a>k", { silent = true, desc = "focus up" } },
				{ "<C-l>", "<C-a>l", { silent = true, desc = "focus right" } },
			},
		}
